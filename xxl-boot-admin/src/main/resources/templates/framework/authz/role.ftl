			...
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<div class="modal-body">
						<form class="form-horizontal form" role="form" >
							<div class="form-group">
								<label for="lastname" class="col-sm-2 control-label"><font color="red">*</font>${I18n.role_tips}${I18n.role_name}</label>
							...
							<div class="form-group">
								<label for="lastname" class="col-sm-2 control-label"><font color="red">*</font>${I18n.role_tips}${I18n.role_code}</label>
							...
							<div class="form-group">
								<label for="lastname" class="col-sm-2 control-label"><font color="red">*</font>${I18n.system_order}</label>
...
$(function() {
	...
	$.adminTable.initTable({
		table: '#data_list',
		url: base_url + "/authz/role/pageList",
	...
	$.adminTable.initDelete({
		url: base_url + "/authz/role/delete"
	});
	 ...
	 */
	$.adminTable.initAdd( {
		url: base_url + "/authz/role/insert",
	...
	$.adminTable.initUpdate( {
		url: base_url + "/authz/role/update",
	...
	$("#data_operation .allocateResource").click(function(){
		...
		$.ajax({
			type : 'POST',
			url : base_url + "/authz/role/loadRoleRes",
			data: {
				"roleId":roleId
			},
			dataType : "json",
	...
	function initTree(){
		...
		$.ajax({
			type : 'POST',
			url : base_url + "/authz/resource/simpleTreeList",
			dataType : "json",
			async: false,
			success : function(data){
				if (data.code == "200") {
