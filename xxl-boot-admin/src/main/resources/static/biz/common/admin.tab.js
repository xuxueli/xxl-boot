$(function () {
    ...
    function closeTab() {
        ...
        syncMenuActive($('.page-tabs-content').find('.active').attr('data-id'));
        return false;
    }
    ...
    var $menuItem = $('.J_menuItem').filter('a[href$="' + decodeURI(hashPath) + '"]');
