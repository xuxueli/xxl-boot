...
VALUES (1, 0, '首页', 1, 'dashboard', '/dashboard', 'fa-home', 100, 0, 0, now(), now()),
       ...
       (5, 2, '资源管理', 1, 'org:resource', '/org/resource', '', 903, 0, 0, now(), now()),
       (6, 2, '组织管理', 1, 'org:org', '/org/org', '', 904, 0, 0, now(), now()),
       (7, 0, '系统管理', 0, 'system', '/system', 'fa-cogs', 910, 0, 0, now(), now()),
       (8, 7, '字典管理', 1, 'system:dict', '/system/dict', '', 911, 0, 0, now(), now()),
       (9, 7, '配置管理', 1, 'system:config', '/system/config', '', 912, 0, 0, now(), now()),
       (10, 7, '站内消息', 1, 'system:message', '/system/message', '', 913, 0, 0, now(), now()),
       (11, 7, '审计日志', 1, 'system:log', '/system/log', '', 914, 0, 0, now(), now()),
       (12, 0, '系统工具', 0, 'tool', '/tool', 'fa-wrench', 920, 0, 0, now(), now()),
       (13, 12, '代码生成', 1, 'tool:codegen', '/tool/codegen', '', 921, 0, 0, now(), now()),
       (14, 12, '表单构建', 1, 'tool:pagegen', '/tool/pagegen', '', 922, 0, 0, now(), now()),
       (15, 0, '帮助中心', 1, 'help', '/help', 'fa-book', 930, 0, 0, now(), now());
...
INSERT INTO `xxl_boot_org` (`id`, `parent_id`, `name`, `order`, `status`, `manager`, `add_time`, `update_time`)
VALUES (1, 0, 'XXL-BOOT项目组', 1, 0, 'admin', now(), now()),
...
VALUES (0, 'XXL-BOOT | 快速开发平台', '<p><strong>XXL-BOOT </strong>是一个快速开发平台，易学易用、扩展丰富、开箱即用。整合前后端流行技术，致力为 中小企业、个人开发者 打造开箱即用的中后台解决方案。</p>', 'admin', 0, now(), now()),
       (0, 'XXL-BOOT | 快速开发平台', '<p><strong>XXL-BOOT </strong>是一个快速开发平台，易学易用、扩展丰富、开箱即用。整合前后端流行技术，致力为 中小企业、个人开发者 打造开箱即用的中后台解决方案。</p>', 'admin', 0, now(), now()),
       (0, 'XXL-BOOT | 快速开发平台', '<p><strong>XXL-BOOT </strong>是一个快速开发平台，易学易用、扩展丰富、开箱即用。整合前后端流行技术，致力为 中小企业、个人开发者 打造开箱即用的中后台解决方案。</p>', 'admin', 0, now(), now()),
       (0, 'XXL-BOOT | 快速开发平台', '<p><strong>XXL-BOOT </strong>是一个快速开发平台，易学易用、扩展丰富、开箱即用。整合前后端流行技术，致力为 中小企业、个人开发者 打造开箱即用的中后台解决方案。</p>', 'admin', 0, now(), now()),
       (0, 'XXL-BOOT 新版发布 | 快速开发平台', '<p><strong>XXL-BOOT </strong>是一个快速开发平台，易学易用、扩展丰富、开箱即用。整合前后端流行技术，致力为 中小企业、个人开发者 打造开箱即用的中后台解决方案。</p>
