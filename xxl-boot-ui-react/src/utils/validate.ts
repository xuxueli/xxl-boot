 ...
 *   - ?   匹配单级路径中的单个字符
 *
 * @param pattern 含通配符的路径模式，支持 * / ** / ? 通配符
 * @param path    待匹配的实际路径字符串
 * @returns 路径与模式匹配时返回 true
 */
 ...
 * @returns 包含 http:// 或 https:// 时返回 true
 */
