...
xxl-boot 前端管理后台，基于 **Vue 3 (Composition API + `<script setup lang="ts">`)**、**TypeScript**、**Element Plus 2**、**Pinia**、**Vite 8** 构建的企业级中后台解决方案。
...
| 开发语言 | TypeScript 5.9（strict 全开） | 静态类型检查 |
| 构建工具 | Vite 8 | 开发服务器与打包 |
| UI 组件库 | Element Plus 2.13 | 组件库与图标 |
| 状态管理 | Pinia 4 | 响应式状态管理 |
