...
export function makeUpJs(conf: FormConf & { fields: FormItemConf[] }, type: string): string {
  conf = JSON.parse(JSON.stringify(conf)) as FormConf & { fields: FormItemConf[] }
 ...
 * @return {*}
 */
function buildOptionMethod(methodName: string, model: string, methodList: string[]) {
 ...
 * @return {*}
 */
function buildProps(conf: FormItemConf, propsList: string[]) {
  if (conf.dataType === 'dynamic') {
 ...
 * @return {*}
 */
function buildBeforeUpload(conf: FormItemConf): string {
 ...
 * @return {*}
 */
function buildSubmitUpload(conf: FormItemConf): string {
