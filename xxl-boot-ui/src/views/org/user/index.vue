    ...
    <div class="tree-sidebar-content">
      <div class="content-inner">
        ...
        <el-table v-loading="loading" :data="userList" @selection-change="handleSelectionChange">
          ...
          <el-table-column label="用户名称" align="center" key="realName" prop="realName" v-if="columns.realName.visible" :show-overflow-tooltip="true" />
...
const columns = ref({
  ...
  realName: { label: '用户名称', visible: true },
