...
- vue 前端script代码结构规范，除基础import外，按照 “ref data → fun → page init” 的顺序组织三个分类，分类代码顶部 /* --- {功能，前后33个-} --- */ 注释区分。参考 `views/system/message/index.vue` 中代码。
- **响应式数据说明**
...
- 方法注释：遵循业界标准注释方式，使用 `/* xxx */` 多行展示注释。除方法注释外，方法内部的分支逻辑也需添加注释。
